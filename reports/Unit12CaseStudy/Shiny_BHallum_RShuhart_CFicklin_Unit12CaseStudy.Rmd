...
## Results
The following are vizualizations of the birth and completion times for a tree using the same data from Fig 7.4 in <i><b>Data Science in R</i></b> by Deborah Nolan and Duncan Temple Lang. In Figure 1, the design is mostly the same as used in the book, however, it is interactive and lambda, kappa, max generation, and random seed are adjustable. Figure 2 is an alternative view as a downward facing tree. 
